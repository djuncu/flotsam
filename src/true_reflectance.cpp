...
namespace flotsam {
  ...
  template 
  int true_reflectance<false>(const BandProfile& band,
  ...
  int true_reflectance<true>(const BandProfile& band,
		  ...
		  const Array<2,Real,true>& pfc_particulate,
                  //const scalar<true>::type& cos_sza, 
